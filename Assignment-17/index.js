...
const locationsInfo = document.getElementById("locations");
let flag;
for(const element of locationList) {
  if(element.country == "India") {
    flag = "./images/india-flag.png";
  }
  else if(element.country == "United States") {
  ...
  locationsInfo.innerHTML += "<tr> <td> <img src=' "+flag+" ' /> </td> <td> "+element.state+" </td> <td> "+element.city+" </td> <td> "+element.contact+" </td> </tr>";
}